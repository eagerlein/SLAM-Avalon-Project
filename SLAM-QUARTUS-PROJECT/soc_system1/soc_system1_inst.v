	soc_system1 u0 (
		...
		.readysig_export_led               (<connected-to-readysig_export_led>),               // readysig_export.led
		.readysig_export_led1              (<connected-to-readysig_export_led1>),              //                .led1
		.readysig_export_led2              (<connected-to-readysig_export_led2>),              //                .led2
		.readysig_export_led4              (<connected-to-readysig_export_led4>),              //                .led4
		.readysig_export_led3              (<connected-to-readysig_export_led3>),              //                .led3
